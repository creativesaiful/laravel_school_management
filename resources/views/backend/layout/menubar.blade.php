      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="{{Route::currentRouteName()=='user.profile' ? 'active' : ''}}"><a href="{{route('user.profile')}}"><i class="ti-more"></i>User Profile</a></li>
            <li class="{{Route::currentRouteName()=='user.edit' ? 'active' : ''}}" ><a href="{{route('user.edit')}}"><i class="ti-more"></i>Update Profile</a></li>
            <li class="{{Route::currentRouteName()=='user.edit.password' ? 'active' : ''}}" ><a href="{{route('user.edit.password')}}"><i class="ti-more"></i>Change Password</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="{{Route::currentRouteName()=='add.user' ? 'active' : ''}}"><a href="{{route('add.user')}}"><i class="ti-more"></i>Add User</a></li>
            <li class="{{Route::currentRouteName()=='user.list' ? 'active' : ''}}"><a href="{{route('user.list')}}"><i class="ti-more"></i>User List </a></li>
